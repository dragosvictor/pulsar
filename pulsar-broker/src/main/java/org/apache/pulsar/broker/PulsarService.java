...
import org.apache.pulsar.broker.stats.OpenTelemetryManagedLedgerStats;
...
public class PulsarService implements AutoCloseable, ShutdownService {
    ...
    private OpenTelemetryManagedLedgerStats openTelemetryManagedLedgerStats;
    ...
    public CompletableFuture<Void> closeAsync() {
        ...
        try {
            ...
            if (openTelemetryManagedLedgerStats != null) {
                openTelemetryManagedLedgerStats.close();
                openTelemetryManagedLedgerStats = null;
            }
    ...
    public void start() throws PulsarServerException {
        ...
        try {
            ...
            openTelemetryManagedLedgerStats = new OpenTelemetryManagedLedgerStats(this);
